...
This project uses Windows-specific libraries (Windows.h and conio.h), so it will only run on Windows systems.
...
Download the project files, and open the .exe file. The game will open automatically in Command Prompt with no additional setup required.


*Option 2 – Compile the Source Code*

If you want to compile the .cpp file yourself:

Open the project in your IDE, Build it and run the program.
